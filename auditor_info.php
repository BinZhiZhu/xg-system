...
$sql="select id, name,sex,username, phone,email,login_num,wtime,ip from auditor order by id";
...
<table class="table table-hover table-bordered">
  ...
  <?php
      ...
      echo "<td><a href='edit_auditor.php?id={$row['id']}'>编辑</a>
            <a href='action.php?action=delete_auditor_info&id={$row['id']}' onclick='return del()'>删除</a></td>";
      echo '</tr>';
    }
        echo '</table>';
         echo '</div>';
