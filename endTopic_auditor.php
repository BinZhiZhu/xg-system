...
<table class="table table-hover table-bordered" border="1" cellspacing="0">
...
<?php
   ...
   require_once('include/page_one.class.php'); //分页类  
    ...
    $sql = "select id,topic_id,topic_name,teacher_id,teacher_name,class,topic_type,status from topics where status in('通过','不通过')";
...
while ($row=mysqli_fetch_assoc($query)) {
  ...
  echo "<td><a href='topic_show.php?id=$row[id]'>详情</a></td>";
	echo '</tr>';
}
